...
//	  }
	...
	{
		List<Disease> diseasename=dsjpa.getDiseases();
		return diseasename;
	}
	@GetMapping("pt")
	public List<PatientDiagnosis> getdia()
	{
		List<PatientDiagnosis> pat2=pdjpa.findAll();
		return pat2;
	}
	@PostMapping("/ptd")
	public PatientDiagnosis create1(@RequestBody PatientDiagnosis ptd) {
		pdjpa.save(ptd);
		System.out.println();
		return ptd;
	}
